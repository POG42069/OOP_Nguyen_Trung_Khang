...
class BattleIntegrationTest(unittest.TestCase):
    def test_three_factions_share_one_territory_arena_and_survivors_keep_hp(self) -> None:
    ...
    def test_worker_hp_is_a_shelter_shield_before_the_queen_core(self) -> None:
    ...
    def test_new_rival_pauses_core_damage_and_reopens_ffa(self) -> None:
        defender = HumanPlayer(0, "Defender", (220, 70, 60))
        attacker = HumanPlayer(1, "Attacker", (60, 120, 220))
    ...
    def test_return_falls_back_to_nearest_owned_region_and_preserves_hp(self) -> None:
