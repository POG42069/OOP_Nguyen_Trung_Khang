...
class BalanceSimulationTest(unittest.TestCase):
    def test_headless_simulation_uses_the_real_strategy_distribution(self) -> None:
    ...
    def test_bot_strategies_enforce_their_defense_reserve(self) -> None:
        expected = (
    ...
    def test_balanced_bot_waits_for_enough_objective_troops_after_reserve(self) -> None:
        match = Match(
            ["bot", "human"],
            seed=31,
    ...
    def test_strategy_upgrade_saving_matches_each_role(self) -> None:
    ...
    def test_aggressive_probe_only_raids_an_exposed_economy(self) -> None:
        match = Match(
            ["bot", "human"],
            seed=47,
    ...
    def test_recent_attack_memory_blocks_only_third_party_cleanup(self) -> None:
    ...
    def test_economic_bot_prioritizes_worker_roi(self) -> None:
        match = Match(
            ["bot", "human"],
            seed=46,
    ...
    def test_balanced_strategy_fortifies_only_the_frontline_region(self) -> None:
        match = Match(
    ...
    def test_balanced_bot_treats_its_only_region_as_frontline(self) -> None:
        match = Match(
            ["bot", "human"],
            seed=45,
            bot_strategy_classes=[BalancedStrategy],
    ...
    def test_seed_reproduces_bot_decisions_and_match_state(self) -> None:
